...
==============
	...
	- Centro de costo
	- Disponer de un número de referencia de factura, motivo y monto

Causar un gasto
===============

	Para causar un gasto realice los siguientes pasos:

		- Ejecute la opción *Causación de gastos*
		- En la lista 'Almacén' seleccione el centro de costo donde se produce el gasto
