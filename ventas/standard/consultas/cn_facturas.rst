...
Ud podrá remitirse a este informe para:
	...
	**Consultas**
	...
	- Los números de las facturas procesadas por un vendedor específico en un momento determinado.
...
*Para realizar cualquiera de estas operaciones, debe hacer click en el botón |export1.gif| al final de la fila de cada factura y elegir la opción conveniente*

	- Imprimir una factura
	- Enviar factura a PDF
	- Anular una factura
	- Modificar la factura
	- Cambiar cliente en la factura
	- Cambiar vendedor en la factura
	- Cambiar seriales en la factura
